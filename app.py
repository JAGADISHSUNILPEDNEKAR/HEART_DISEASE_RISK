...
# Page configuration
st.set_page_config(
    page_title="Heart Disease Risk Predictor", page_icon="🫀", layout="centered"
)
    ...
    with st.form("prediction_form"):
        ...
        with c2:
            ...
            thalch = st.number_input(
                "Max Heart Rate Achieved", min_value=50, max_value=250, value=150
            )
            ...
            ca = st.number_input(
                "Number of Major Vessels (0-3)", min_value=0, max_value=4, value=0
            )  # Data allows 0-3, sometimes 4 in dirty data but 3 is major
            thal = st.selectbox(
